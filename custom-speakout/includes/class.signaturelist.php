...
class dk_speakout_Signaturelist
{
	 ...
	 */
	public static function table( $id, $start, $limit, $context = 'shortcode', $dateformat = 'M d, Y', $firstbuttontext = '&lt;&lt;', $nextbuttontext = '&gt;', $prevbuttontext = '&lt;', $lastbuttontext = '&gt;&gt;', $hideUnconfirmed = null ) {
                ...
                $linkOption = 2;
            			...
            			foreach ( $signatures as $signature ) {
            				...
            				if($options['display_flags']== 'on'){
            				    ...
            				    $flag_image = '<img src="' . esc_url( plugins_url( 'images/flags/' . $flag, DK_SPEAKOUT_PLUGIN_FILE ) ) . '" class="dk-speakout-signaturelist-flag-icon"> ';
            				}
            				else{
            				    $flag_image = "";
            				}
