...
//	}
	...
	$confirmation_page .= 	'<title>' . get_bloginfo( "name" ) . '</title>
			<style type="text/css">
				...
				#confirmation {
					background: #fff url(' . plugins_url( 'images/mail-stripes.png', DK_SPEAKOUT_PLUGIN_FILE ) . ') repeat top left;
				...
				#confirmation-content {
					background: #fff url(' . plugins_url( 'images/postmark.png', DK_SPEAKOUT_PLUGIN_FILE ) . ') no-repeat top right;
					margin: 10px;
