...
<?php
   ...
   if(get_option( 'dk_speakout_license_key_verified' ) == 1  && get_option( 'dk_speakout_license_key' ) != ""){
        ...
        <td> 
            <input type="button" id="licenseKeyRevoke" name="licenseKeyRevoke"  class="licenseKeyRevoke" value="'. __( "Revoke license key", "speakout"). '"  > <span><img style="display:none;" id="speakOutLoader" src="' . esc_url( plugins_url( 'images/loader.gif', DK_SPEAKOUT_PLUGIN_FILE ) ) . '"></span>
        </td>                
	    <tr>
            <td>
	    ...
	    <td> 
            <input type="button" id="licenseKeyButton" name="licenseKeyButton" class="licenseKeyButton" value="'. __( "Verify", "speakout"). '"  > <span><img style="display:none;" id="speakOutLoader" src="' . esc_url( plugins_url( 'images/loader.gif', DK_SPEAKOUT_PLUGIN_FILE ) ) . '"></span>
        </td>
	    ';
    }
    ?>
