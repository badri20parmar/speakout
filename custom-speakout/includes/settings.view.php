...
<div class="wrap" id="dk-speakout">
	...
	<form action="" method="post" id="dk-speakout-settings">
		...
		<ul id="dk-speakout-tabbar">
            ...
            <li><a class="dk-speakout-tab-07" rel="dk-speakout-tab-07"><?php _e( 'Diagnostics', 'speakout' ); ?></a></li>
                ...
                <tr valign="top">
					...
					<td>
					    ...
					    <div id="dk-speakout-recaptcha-keys">
                            <label for="recaptcha-version" /><input type="radio" name="g_recaptcha_version" value='2' id="recaptcha-version" <?php if ( $the_settings->g_recaptcha_version == 2 ) echo 'checked="checked"'; ?> /> Version 2</label>
                            <br>
        ...
        <div id="dk-speakout-tab-06" class="dk-speakout-hidden dk-speakout-tabcontent">
         ...
         <div id="dk-speakout-tab-07" class="dk-speakout-hidden dk-speakout-tabcontent">
             <h3><?php _e( 'Diagnostics', 'speakout' ); ?></h3>
             <p><?php _e( 'Use this section to view plugin options for troubleshooting and support.', 'speakout' ); ?></p>
