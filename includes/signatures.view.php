        ...
        <div class="dk_speakout_clear">
            <div class="alignleft">
                ...
                <form id='dk-speakout-bulk-action-form' action="" method="get" class="dk-sigform">
                    ...
                    <label for="dk-speakout-csv-date-from" class="screen-reader-text"><?php _e("Export from date", "speakout"); ?></label>
                    <input type="date" id="dk-speakout-csv-date-from" name="csv_date_from" title="<?php _e("CSV date from", "speakout"); ?>" />
                    <label for="dk-speakout-csv-date-to" class="screen-reader-text"><?php _e("Export to date", "speakout"); ?></label>
                    <input type="date" id="dk-speakout-csv-date-to" name="csv_date_to" title="<?php _e("CSV date to", "speakout"); ?>" />
                    <label for="dk-speakout-csv-status" class="screen-reader-text"><?php _e("CSV status", "speakout"); ?></label>
                    <select id="dk-speakout-csv-status" name="csv_status" title="<?php _e("CSV status filter", "speakout"); ?>">
                        <option value=""><?php _e("All statuses", "speakout"); ?></option>
                        <option value="confirmed"><?php _e("Confirmed", "speakout"); ?></option>
                        <option value="unconfirmed"><?php _e("Unconfirmed", "speakout"); ?></option>
                    </select>
